...
class cfg(base_cfg):
    def __init__(self):
        ...
        self.synthetic_local_anomaly.frequency_appearance_mode = 'joint_fusion'
        self.synthetic_local_anomaly.frequency_vis_dir = 'outputs/frequency_synthesis_vis/ablate_F_full'
