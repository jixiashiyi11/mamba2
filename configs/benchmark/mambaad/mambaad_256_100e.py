...
class cfg(cfg_common, cfg_dataset_default, cfg_model_mambaad):
    ...
    def __init__(self):
       ...
       self.model.kwargs = dict(pretrained=False,checkpoint_path='/home/wmwanghkmu/ZYH/Mamba/ADer/runs/MAMBAADTrainer_configs_benchmark_mambaad_mambaad_256_100e_20260412-191157/net_90.pth',strict=True, model_t=self.model_t, model_s=self.model_s)
