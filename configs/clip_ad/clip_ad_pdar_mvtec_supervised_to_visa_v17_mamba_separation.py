...
class cfg(base_cfg):
    """V17 complete config: V13 architecture plus Mamba separation loss."""
    ...
    def __init__(self):
        ...
        # ------------------------- model / losses ------------------------
        # Complete V17 model configuration. These values consolidate the
        # effective settings previously inherited through the cross-domain
        # config and V2/V3/V4/V9/V12/V13.
        self.model.kwargs.update(
            ...
            mamba_context_separation_weight=0.1,
        ...
        self.logging.log_terms_train.extend(
            [
                ...
                dict(name="loss_mamba_context_separation", fmt=":>5.3f", add_name="avg"),
            ]
        )
        ...
        self.trainer.logdir_sub = (
            "pdar_mvtec_supervised_to_visa_v17_mamba_separation"
        )
